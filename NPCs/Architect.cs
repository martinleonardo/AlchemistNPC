...
namespace AlchemistNPC.NPCs
{
    ...
    public class Architect : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            LocalizationLoader.AddTranslation(text);
            text = LocalizationLoader.CreateTranslation(Mod, "Bob");
            text.SetDefault("Bob");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Боб");
            LocalizationLoader.AddTranslation(text);
            ...
            text.SetDefault("What? Where I've got my architect degree? What's that?");
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "你听说过一个叫FuryForged的家伙吗?他的一切东西都是我教的");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "我曾经被一家公司雇用来建造一个超大规模的高科技，高安全性装置。 让我告诉你我在安全性和阻挡入侵方面我的巨大建树。");
            LocalizationLoader.AddTranslation(text);
            text = LocalizationLoader.CreateTranslation(Mod, "AS1");
            text.SetDefault("1st shop (Filler Blocks)       ");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "1-ый магазин (Обычные Блоки)");
