...
namespace AlchemistNPC.NPCs
{
    ...
    public class Operator : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ModTranslation text = LocalizationLoader.CreateTranslation(Mod, "EGOShop");
            ...
            text = LocalizationLoader.CreateTranslation(Mod, "BossDropsShop");
            ...
            LocalizationLoader.AddTranslation(text);
            text = LocalizationLoader.CreateTranslation(Mod, "Meteorite");
            text.SetDefault("Meteorite");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Метеорит");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "老实说，我不知道为什么巨大的旋转头骨是一切的关键，但不知何故，它们似乎包含着天人的力量…");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "是的，我知道我们是捕获和饲养恐怖的怪物的人。但谁会认为把宝藏袋放在一个巨大的怪物里面是个好主意呢？！？你看！");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "КEmember经理，宝藏袋很值钱，但不是所有东西都在里面。那个变种人能帮你得到Boss的稀有掉落物。");
        ...
        public override bool CheckConditions(int left, int right, int top, int bottom)
        {
            ...
            for (int x = left; x <= right; x++)
            {
                for (int y = top; y <= bottom; y++)
                {
                    ...
                    if (type == TileType<Tiles.WingoftheWorld>())
                    {
                        score++;
                    }
                }
        ...
        public override void TownNPCAttackProj(ref int projType, ref int attackDelay)
        {
            ...
            if (!Main.hardMode)
            {
                projType = ProjectileType<Projectiles.BB>();
            }
            if (Main.hardMode && !NPC.downedMoonlord)
            {
                projType = ProjectileType<Projectiles.FDB>();
            }
            if (NPC.downedMoonlord)
            {
                projType = ProjectileType<Projectiles.MB>();
            }
        }
        ...
        public override void DrawTownAttackGun(ref float scale, ref int item, ref int closeness) //Allows you to customize how this town NPC's weapon is drawn when this NPC is shooting (this NPC must have an attack type of 1). Scale is a multiplier for the item's drawing size, item is the ID of the item to be drawn, and closeness is how close the item should be drawn to the NPC.
        {
            ...
            if (!Main.hardMode)
            {
                item = ModContent.ItemType<Items.Weapons.TheBeak>();
            }
            if (Main.hardMode && !NPC.downedMoonlord)
            {
                item = ModContent.ItemType<Items.Weapons.FuneralofDeadButterflies>();
            }
            if (NPC.downedMoonlord)
            {
                item = ModContent.ItemType<Items.Weapons.MagicBullet>();
            }
        }
        ...
        public override void SetChatButtons(ref string button, ref string button2)
        {
            ...
            if (player.active)
            {
                ...
                {
                    if (player.inventory[j].type == ModContent.ItemType<Items.Misc.SymbioteMeteorite>())
                    {
                        Meteor = true;
                    }
                }
        ...
        public override void OnChatButtonClicked(bool firstButton, ref bool shop)
        {
            if (firstButton)
            {
                ...
                {
                    Player player = Main.player[Main.myPlayer];
                    player.QuickSpawnItem(ModContent.ItemType<Items.Equippable.Symbiote>());
                    if (Main.player[Main.myPlayer].HasItem(ModContent.ItemType<Items.Misc.SymbioteMeteorite>()) && Meteor)
                    {
                        Item[] inventory = Main.player[Main.myPlayer].inventory;
                        for (int k = 0; k < inventory.Length; k++)
                        {
                            if (inventory[k].type == ModContent.ItemType<Items.Misc.SymbioteMeteorite>() && Meteor)
                            {
                                inventory[k].stack--;
                                Meteor = false;
                            }
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)
        {
            ...
            for (int k = 0; k < 255; k++)
            {
                ...
                if (player.active && player == Main.LocalPlayer)
                {
                    for (int index1 = 0; index1 < 40; ++index1)
                    {
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier1>());
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier2>());
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier3>());
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier4>());
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier5>());
                        ...
                        {
                            player.bank3.item[index1].SetDefaults(ModContent.ItemType<Items.Misc.ReversivityCoinTier6>());
            ...
            if (Shop == 11)
            {
				...
				*/
                if (NPC.downedMechBossAny)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Materials.DivineLava>());
                    shop.item[nextSlot].shopCustomPrice = 20000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Materials.CursedIce>());
                    shop.item[nextSlot].shopCustomPrice = 20000;
                    nextSlot++;
                }
                // IMPLEMENT WHEN WEAKREFERENCES FIXED
            ...
            if (Shop == 2)
            {
                ...
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Misc.WorldControlUnit>());
                ...
                if (NPC.downedMoonlord)
                {
                    ...
                    {
                        shop.item[nextSlot].SetDefaults(ItemType<Items.TerrainReformer>());
                        shop.item[nextSlot].shopCustomPrice = new int?(30);
                ...
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorSnow>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorDesert>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorJungle>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorCorruption>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorCrimson>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorSpace>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                if (NPC.downedBoss3)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorDungeon>());
                    shop.item[nextSlot].shopCustomPrice = 250000;
                    nextSlot++;
                }
                if (Main.hardMode)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.HoloprojectorHallowed>());
                    shop.item[nextSlot].shopCustomPrice = 330000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Misc.GlobalTeleporter>());
                    nextSlot++;
                }
                if (NPC.downedBoss3)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.TheBeak>());
                    shop.item[nextSlot].shopCustomPrice = 200000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.LaetitiaRibbon>());
                    shop.item[nextSlot].shopCustomPrice = 100000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.LaetitiaCoat>());
                    shop.item[nextSlot].shopCustomPrice = 200000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.LaetitiaLeggings>());
                    shop.item[nextSlot].shopCustomPrice = 150000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.Laetitia>());
                    shop.item[nextSlot].shopCustomPrice = 350000;
                    nextSlot++;
                }
                if (NPC.downedMechBossAny)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.FuneralofDeadButterflies>());
                    shop.item[nextSlot].shopCustomPrice = 500000;
                    nextSlot++;
                }
                if (NPC.downedMechBoss1 && NPC.downedMechBoss2 && NPC.downedMechBoss3)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Equippable.LaetitiaGift>());
                    shop.item[nextSlot].shopCustomPrice = 300000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.ReverberationHead>());
                    shop.item[nextSlot].shopCustomPrice = 250000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.ReverberationBody>());
                    shop.item[nextSlot].shopCustomPrice = 350000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Armor.ReverberationLegs>());
                    shop.item[nextSlot].shopCustomPrice = 300000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.Reverberation>());
                    shop.item[nextSlot].shopCustomPrice = 500000;
                    nextSlot++;
                }
                if (NPC.downedPlantBoss)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Equippable.BigBirdLamp>());
                    shop.item[nextSlot].shopCustomPrice = 750000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.GrinderMK4>());
                    shop.item[nextSlot].shopCustomPrice = 750000;
                    nextSlot++;
                }
                if (NPC.downedGolemBoss)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Weapons.Spore>());
            ...
            if (Shop == 3)
            {
                if (!NPC.downedBoss3)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Notes.InformatingNote>());
                    nextSlot++;
                }
                if (AlchemistNPC.modConfiguration.CoinsDrop)
                {
