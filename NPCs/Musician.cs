...
namespace AlchemistNPC.NPCs
{
    ...
    public class Musician : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "音乐家");
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "第2商店");
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "第3商店");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "贝多芬");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "巴赫");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "约翰");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "爱迪生");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "斯科特");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "劳埃德");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "伽马");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "我会戴耳机，但我不确定泰拉人能不能听见…");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "我想知道为什么Boss1和Boss2在OST中没有更好的名字。那些名字很很很很平淡。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "听着，电子人可能有我的名字，但我在这里还有更好的工作。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "嘘！！！！！你会毁了我的录音！");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "我发誓，如果有人再让我卖给他们一个“Megalovania”八音盒的话…");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "听着，你这么热心真是太好了，但是你能不能把下一个Boss的音乐记录下来？我真的不想为了一些曲调而冒自己的生命危险。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "啊，我看到你救了探险家！做得好！也许我的下一首歌是关于你的胜利。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "你知道，");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "对我安装这个音响系统真的很有帮助。电线是关键！");
            LocalizationLoader.AddTranslation(text);
            text = LocalizationLoader.CreateTranslation(Mod, "EntryM10");
            text.SetDefault("If you run into ");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "如果你遇到");
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "，让他知道他还欠我卖给他的那些八音盒钱。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "老实说，我不确定我是否相信");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "。他声称没有被附身，但他仍在用头骨战斗…我收到的信息混杂不一。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "伙计，我的混音带比这个好得多，但由于版权问题，我不能卖给你。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "不，我没有“全明星”八音盒。用你自己的代码。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "等等，NPC？我以为我是主角！");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "没想到我会卖一个带歌词的八音盒…DM DOKURO，是个疯狂的人，我喜欢！");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "整个基础音乐系列？听起来太棒了！很糟糕，我没有装备，嗯？");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "这是你的错。出。去。");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "啊，我回来了！我记得这首歌曾经在地牢和地下演奏…真是好时光！");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "有没有一个名字是因为害怕被蛋糕监视？");
            LocalizationLoader.AddTranslation(text);
            ...
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "你在伤害我的耳朵! 把它给我关了! ");
            LocalizationLoader.AddTranslation(text);
        ...
        public override string GetChat()
        {
            ...
            int Explorer = NPC.FindFirstNPC(NPCType<NPCs.Explorer>());
            int Musician = NPC.FindFirstNPC(NPCType<NPCs.Musician>());
		...
		*/
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)
        {
            ...
            if (S3)
            {
                shop.item[nextSlot].SetDefaults(ItemType<Items.Misc.BoomBox>());
                shop.item[nextSlot].shopCustomPrice = 250000;
                nextSlot++;
                if (Main.hardMode)
                {
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.FieldsMusicBox>());
                    shop.item[nextSlot].shopCustomPrice = 400000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.SheamMusicBox>());
                    shop.item[nextSlot].shopCustomPrice = 250000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.ChaosKingMusicBox>());
                    shop.item[nextSlot].shopCustomPrice = 250000;
                    nextSlot++;
                    shop.item[nextSlot].SetDefaults(ItemType<Items.Placeable.TheWorldRevolvingMusicBox>());
                    shop.item[nextSlot].shopCustomPrice = 250000;
                    nextSlot++;
                }
				// IMPLEMENT WHEN WEAKREFERENCES FIXED
