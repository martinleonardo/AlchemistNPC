			...
			for (int h = 0; h < 2; h++)
				{
					...
					vel *= 5f;
					Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vel.X, vel.Y, ModContent.ProjectileType<Projectiles.Home>(), Projectile.damage/3, 0, Main.myPlayer);
				}
			return true;
		}
