	...
	public class DemonicBullet : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			if (Projectile.penetrate <= 0)
			{
				...
				vel *= 0f;
				Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vel.X, vel.Y, ModContent.ProjectileType<Projectiles.DemonicExplosion>(), Projectile.damage, 0, Main.myPlayer);
			}
			return false;
		}
