...
namespace AlchemistNPC.Projectiles
{
	public class RedWave : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			vel *= 0f;
			Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vel.X, vel.Y, ModContent.ProjectileType<Projectiles.RedWaveExp>(), Projectile.damage, 0, Main.myPlayer);
		}
